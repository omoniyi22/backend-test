      ...
      <Toolbar>
        {isMediumScreen ? (
          ...
          >
            ...
            {/* Third part (25%) */}
            <Grid item direction={"row"} style={{ display: "flex", flexDirection: "row", flexGap:"10px"}}>
              {/* Animation button */}
              <Button
                variant="contained"
          ...
          >
            ...
            {/* Third part (25%) */}
            <Grid item xs={6} sx={{ textAlign: "right" }} direction={"row"} style={{ display: "flex", flexDirection: "row" }}>
              {/* Animation button */}
              <Button
                variant="contained"
                className="gradient-button" // Apply the gradient-button class
